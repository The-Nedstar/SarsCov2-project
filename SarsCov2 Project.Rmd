...
BothPlot <- ggplot(Both, aes(x = date, y = count, colour = Data)) +
    geom_line() +
    geom_point() +
    scale_colour_brewer(palette = "Dark2") +
    theme_bw() +
    ggtitle("d) Compbined plot") +
...
png(filename = here("Figures", "BA2LinPlot.png"), height = 20, width = 25, units = "cm", res = 400)
# defining positions
grid.arrange(COGPlot2, COGPlot, ONSPlot, BothPlot, ncol = 2)
dev.off()
```
...
## combinging and saving plot
# defining saving parameters
png(filename = here("Figures", "COGCombPredPlot.png"), height = 20, width = 25, units = "cm", res = 400)
# defining positions
grid.arrange(COGDeltaMPredPlot, COGBA1MPredPlot, COGBA2MPredPlot, 
             COGCombMPredPlot, ncol = 2)
dev.off()
```
